...
public class Messages {
    ...
    public static String COMMAND_PARTY_DEMOTE_SUCCESS = "cmd-party-demote-success";
    public static String COMMAND_PARTY_DEMOTE_USAGE = "cmd-party-demote-usage";
    public static String COMMAND_PARTY_DEMOTE_NOT_MOD = "cmd-party-demote-not-mod";
    public static String COMMAND_PARTY_KICKOFFLINE_SUCCESS = "cmd-party-kickoffline-success";
    public static String COMMAND_PARTY_KICKOFFLINE_NONE = "cmd-party-kickoffline-none";
    public static String COMMAND_PARTY_MUTE_ENABLED = "cmd-party-mute-enabled";
    public static String COMMAND_PARTY_MUTE_DISABLED = "cmd-party-mute-disabled";
    ...
    public static String COMMAND_PARTY_SETTING_HELP = "cmd-party-setting-help";
    public static String COMMAND_PARTY_SETTING_ALLINVITE_ON = "cmd-party-setting-allinvite-on";
