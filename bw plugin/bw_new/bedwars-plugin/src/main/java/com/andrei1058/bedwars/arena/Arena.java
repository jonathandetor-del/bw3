...
public class Arena implements IArena {
    ...
    /**
     * Players being removed due to game restart. Used to prevent party removal on disconnect.
     */
    public static final Set<UUID> restartingPlayers = new HashSet<>();
    ...
    public void removePlayer(@NotNull Player p, boolean disconnect) {
        ...
        // Party persists when leaving waiting lobby — no removal here
