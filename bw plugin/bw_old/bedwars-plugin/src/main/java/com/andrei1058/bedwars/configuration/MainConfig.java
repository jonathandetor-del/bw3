...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_REJOIN_TIME, 60);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_RE_SPAWN_INVULNERABILITY, 1000);
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_START_COUNTDOWN_REGULAR, 10);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_START_COUNTDOWN_HALF, 10);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_START_COUNTDOWN_SHORTENED, 5);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_RESTART, 7);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_RE_SPAWN_COUNTDOWN, 5);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_BEDS_DESTROY_COUNTDOWN, 1800);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_DRAGON_SPAWN_COUNTDOWN, 2100);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_GAME_END_COUNTDOWN, 600);
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_SHOUT_COOLDOWN, 30);
        yml.addDefault(ConfigPath.GENERAL_CONFIG_PLACEHOLDERS_REPLACEMENTS_SERVER_IP, "bistarwars.com");
        yml.addDefault(ConfigPath.GENERAL_CONFIG_PLACEHOLDERS_REPLACEMENTS_POWERED_BY, "Velorsi");
        ...
        yml.addDefault(ConfigPath.GENERAL_TNT_PROTECTION_GLASS_BLAST, 15f);
        yml.addDefault(ConfigPath.GENERAL_TNT_RAY_BLOCKED_BY_GLASS, true);

        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_HORIZONTAL, 0.375);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_VERTICAL, 0.31);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_FRICTION, 2.0);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_MAX_VERTICAL, 0.38);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_EXTRA_HORIZONTAL, 0.425);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_EXTRA_VERTICAL, 0.05);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_AIR_HORIZONTAL, 0.95);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_AIR_VERTICAL, 0.75);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_HORIZONTAL_RANDOM, 0.0);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_VERTICAL_RANDOM, 0.0);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_NO_DAMAGE_TICKS, 20);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_SPRINT_THRESHOLD, 0.08);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_PING_COMP_ENABLED, true);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_PING_COMP_FACTOR, 0.0015);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_PING_COMP_MAX, 40);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_PING_COMP_TICK_REDUCTION_PER_MS, 0.1);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_ATTACKER_SLOWDOWN, 0.80);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_SPRINT_RESET, true);
        yml.addDefault(ConfigPath.GENERAL_MELEE_KB_MAX_HORIZONTAL_VELOCITY, 0.64);
        ...
        yml.addDefault(ConfigPath.CENERAL_CONFIGURATION_ALLOWED_COMMANDS, Arrays.asList("shout", "bw", "leave", "hub", "lobby", "l"));
    ...
    public void saveLobbyCommandItem(String name, String cmd, boolean enchanted, String material, int data, int slot) {
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_COMMAND.replace("%path%", name), cmd);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_MATERIAL.replace("%path%", name), material);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_DATA.replace("%path%", name), data);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_ENCHANTED.replace("%path%", name), enchanted);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_LOBBY_ITEMS_SLOT.replace("%path%", name), slot);
        save();
    }

    private void setIfAbsent(String path, Object value) {
        if (!getYml().isSet(path)) {
    ...
    public void savePreGameCommandItem(String name, String cmd, boolean enchanted, String material, int data, int slot) {
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_COMMAND.replace("%path%", name), cmd);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_MATERIAL.replace("%path%", name), material);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_DATA.replace("%path%", name), data);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_ENCHANTED.replace("%path%", name), enchanted);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_PRE_GAME_ITEMS_SLOT.replace("%path%", name), slot);
        save();
    }
    ...
    public void saveSpectatorCommandItem(String name, String cmd, boolean enchanted, String material, int data, int slot) {
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_COMMAND.replace("%path%", name), cmd);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_MATERIAL.replace("%path%", name), material);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_DATA.replace("%path%", name), data);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_ENCHANTED.replace("%path%", name), enchanted);
        setIfAbsent(ConfigPath.GENERAL_CONFIGURATION_SPECTATOR_ITEMS_SLOT.replace("%path%", name), slot);
        save();
    }
}
