...
public interface Database {
     ...
     * Key is category name, value is hotbar slot (0-8).
     */
    void saveHotbarPreferences(UUID uuid, Map<String, Integer> preferences);

    /**
     * Load hotbar preferences for a player.
     * Returns map of category name to hotbar slot (0-8).
     */
    Map<String, Integer> getHotbarPreferences(UUID uuid);
}
