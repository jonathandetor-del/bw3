...
public class English extends Language {
    ...
    public English() {
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_TITLE + "-5", "&e&l5");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-5", " ");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_TITLE + "-4", "&e&l4");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-4", " ");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_TITLE + "-3", "&c&l3");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-3", " ");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_TITLE + "-2", "&c&l2");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-2", " ");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_TITLE + "-1", "&c&l1");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-1", " ");
        ...
        yml.addDefault(Messages.FORMATTING_CHAT_TEAM, "{level}{vPrefix}{team} &7{player}{vSuffix}: {message}");
        ...
        yml.addDefault(Messages.INTERACT_BED_DESTROY_TITLE_ANNOUNCEMENT, "&c&lBED DESTROYED!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_REGULAR, "{PlayerColor}{PlayerName} &7disconnected while fighting {KillerColor}{KillerName}&7.");
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_FINAL, "{PlayerColor}{PlayerName} &7disconnected while fighting {KillerColor}{KillerName}&7. &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_BY_REGULAR_KILL, "{PlayerColor}{PlayerName} &7was knocked off by {KillerColor}{KillerName}&7.");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_BY_FINAL_KILL, "{PlayerColor}{PlayerName} &7was knocked off by {KillerColor}{KillerName}&7. &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_EXPLOSION_WITH_SOURCE_REGULAR_KILL, "{PlayerColor}{PlayerName} &7was blown up by {KillerColor}{KillerName}&7.");
        yml.addDefault(Messages.PLAYER_DIE_EXPLOSION_WITH_SOURCE_FINAL_KILL, "{PlayerColor}{PlayerName} &7was blown up by {KillerColor}{KillerName}&7. &b&lFINAL KILL!");
        yml.addDefault(Messages.PLAYER_DIE_EXPLOSION_WITHOUT_SOURCE_REGULAR, "{PlayerColor}{PlayerName} &7blew up.");
        yml.addDefault(Messages.PLAYER_DIE_EXPLOSION_WITHOUT_SOURCE_FINAL_KILL, "{PlayerColor}{PlayerName} &7blew up. &b&lFINAL KILL!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_TITLE, "&c&lYOU DIED!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_RESPAWNED_TITLE, "&a&lRESPAWNED!");
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_WAITING_PREFIX, List.of("{teamColor}"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_WAITING_PREFIX_SPEC, List.of(""));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_STARTING_PREFIX, List.of("{teamColor}"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_STARTING_PREFIX_SPEC, List.of(""));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_PLAYING_PREFIX, List.of("{teamColor}"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_PLAYING_ELM_PREFIX, List.of("&7"));
        yml.addDefault(Messages.FORMATTING_SB_TAB_PLAYING_ELM_SUFFIX, List.of(" &c&oEliminated"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_PLAYING_SPEC_PREFIX, List.of("&7"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_WIN1_PREFIX, List.of("{teamColor}"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_WIN2_PREFIX, List.of("{teamColor}"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_ELM_PREFIX, List.of("{teamColor}"));
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_RESTARTING_SPEC_PREFIX, List.of("&7"));
        ...
        yml.addDefault(Messages.HOTBAR_MANAGER_TITLE, "Hotbar Manager");
        yml.addDefault(Messages.HOTBAR_MANAGER_BUTTON_NAME, "&5Hotbar Manager");
        yml.addDefault(Messages.HOTBAR_MANAGER_BUTTON_LORE, Arrays.asList("&7Edit preferred slots for your items", "&7per category.", "", "&eClick to edit!"));
