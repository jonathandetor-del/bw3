...
public class BedWars extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        registerEvents(
                ...
                new GameEndListener(), new DefaultStatsHandler(), new HypixelKnockback(),
                new com.andrei1058.bedwars.arena.team.TeamSelectorGUI(),
                new com.andrei1058.bedwars.lobbynpc.LobbyNPCListener()
        );
        ...
        Bukkit.getScheduler().runTaskLater(plugin, () -> {
            ...
            // Spawn built-in lobby NPCs (no Citizens needed)
            try {
                com.andrei1058.bedwars.lobbynpc.LobbyNPCManager.loadNPCs();
                com.andrei1058.bedwars.lobbynpc.LobbyNPCManager.startRefreshTask();
                // Inject packet handlers for already-online players (in case of reload)
                for (org.bukkit.entity.Player p : Bukkit.getOnlinePlayers()) {
                    com.andrei1058.bedwars.lobbynpc.LobbyNPCListener.injectPlayer(p);
                    com.andrei1058.bedwars.listeners.HypixelKnockback.injectKB(p);
                }
            } catch (Exception e) {
                getLogger().severe("Could not load lobby NPCs: " + e.getMessage());
            }
        }, 5L);
    ...
    private void registerDelayedCommands() {
        ...
        if (!nms.isBukkitCommandRegistered("hub")) {
            nms.registerCommand("hub", new com.andrei1058.bedwars.commands.leave.HubCommand("hub"));
        }
        ...
        nms.registerCommand("pvpdebug", new com.andrei1058.bedwars.commands.PvPDebugCommand("pvpdebug"));
    }
    ...
    public void onDisable() {
        ...
        // Despawn lobby NPCs and clean up packet handlers
        try {
            for (org.bukkit.entity.Player p : Bukkit.getOnlinePlayers()) {
                com.andrei1058.bedwars.lobbynpc.LobbyNPCListener.uninjectPlayer(p);
                com.andrei1058.bedwars.listeners.HypixelKnockback.uninjectKB(p);
            }
            com.andrei1058.bedwars.lobbynpc.LobbyNPCManager.despawnAll();
        } catch (Exception ignored) {
        }
