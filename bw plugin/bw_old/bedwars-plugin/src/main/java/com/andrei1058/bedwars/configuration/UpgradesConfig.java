...
public class UpgradesConfig extends ConfigManager {
    ...
    public UpgradesConfig(String name, String dir) {
        ...
        if (isFirstTime()) {
            ...
            yml.addDefault("upgrade-forge.tier-1.receive", Arrays.asList("generator-edit: iron,1,4,48", "generator-edit: gold,3,1,14"));
            ...
            yml.addDefault("upgrade-forge.tier-2.receive", Arrays.asList("generator-edit: iron,1,4,56", "generator-edit: gold,3,2,21"));
            ...
            yml.addDefault("upgrade-forge.tier-3.receive", Arrays.asList("generator-edit: iron,1,4,64", "generator-edit: gold,3,2,29",
                    "generator-edit: emerald,10,1,4"));
            ...
            yml.addDefault("upgrade-forge.tier-4.receive", Arrays.asList("generator-edit: iron,1,8,120", "generator-edit: gold,2,4,80",
                    "generator-edit: emerald,10,2,4"));
            ...
            yml.addDefault("base-trap-4.receive", Collections.singletonList("player-effect: SLOW_DIGGING,0,10,enemy"));
