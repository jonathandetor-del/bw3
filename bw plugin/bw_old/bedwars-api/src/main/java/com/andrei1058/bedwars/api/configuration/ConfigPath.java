...
public class ConfigPath {
    ...
    public static final String GENERAL_CONFIGURATION_LOBBY_NPC_STORAGE = "lobby-npc-locations";
    ...
    private static final String GENERAL_MELEE_KB_PATH = "melee-knockback";
    public static final String GENERAL_MELEE_KB_HORIZONTAL = GENERAL_MELEE_KB_PATH + ".horizontal";
    public static final String GENERAL_MELEE_KB_VERTICAL = GENERAL_MELEE_KB_PATH + ".vertical";
    public static final String GENERAL_MELEE_KB_FRICTION = GENERAL_MELEE_KB_PATH + ".friction";
    public static final String GENERAL_MELEE_KB_SPRINT_MULTIPLIER = GENERAL_MELEE_KB_PATH + ".sprint-multiplier";
    public static final String GENERAL_MELEE_KB_MAX_HORIZONTAL = GENERAL_MELEE_KB_PATH + ".max-horizontal";
    public static final String GENERAL_MELEE_KB_MAX_VERTICAL = GENERAL_MELEE_KB_PATH + ".max-vertical";
    public static final String GENERAL_MELEE_KB_AIR_MULTIPLIER = GENERAL_MELEE_KB_PATH + ".air-multiplier";
    public static final String GENERAL_MELEE_KB_FIRST_HIT_MULTIPLIER = GENERAL_MELEE_KB_PATH + ".first-hit-multiplier";
    public static final String GENERAL_MELEE_KB_EXTRA_HORIZONTAL = GENERAL_MELEE_KB_PATH + ".extra-horizontal";
    public static final String GENERAL_MELEE_KB_EXTRA_VERTICAL = GENERAL_MELEE_KB_PATH + ".extra-vertical";
    public static final String GENERAL_MELEE_KB_AIR_HORIZONTAL = GENERAL_MELEE_KB_PATH + ".air-horizontal-multiplier";
    public static final String GENERAL_MELEE_KB_AIR_VERTICAL = GENERAL_MELEE_KB_PATH + ".air-vertical-multiplier";
    public static final String GENERAL_MELEE_KB_HORIZONTAL_RANDOM = GENERAL_MELEE_KB_PATH + ".horizontal-random";
    public static final String GENERAL_MELEE_KB_VERTICAL_RANDOM = GENERAL_MELEE_KB_PATH + ".vertical-random";
    public static final String GENERAL_MELEE_KB_NO_DAMAGE_TICKS = GENERAL_MELEE_KB_PATH + ".no-damage-ticks";
    public static final String GENERAL_MELEE_KB_SPRINT_THRESHOLD = GENERAL_MELEE_KB_PATH + ".sprint-reset-threshold";
    public static final String GENERAL_MELEE_KB_PING_COMP_ENABLED = GENERAL_MELEE_KB_PATH + ".ping-compensation.enabled";
    public static final String GENERAL_MELEE_KB_PING_COMP_FACTOR = GENERAL_MELEE_KB_PATH + ".ping-compensation.factor";
    public static final String GENERAL_MELEE_KB_PING_COMP_MAX = GENERAL_MELEE_KB_PATH + ".ping-compensation.max-compensation-ms";
    public static final String GENERAL_MELEE_KB_PING_COMP_TICK_REDUCTION_PER_MS = GENERAL_MELEE_KB_PATH + ".ping-compensation.tick-reduction-per-ms";
    public static final String GENERAL_MELEE_KB_ATTACKER_SLOWDOWN = GENERAL_MELEE_KB_PATH + ".attacker-slowdown";
    public static final String GENERAL_MELEE_KB_SPRINT_RESET = GENERAL_MELEE_KB_PATH + ".sprint-reset";
    public static final String GENERAL_MELEE_KB_MAX_HORIZONTAL_VELOCITY = GENERAL_MELEE_KB_PATH + ".max-horizontal-velocity";
